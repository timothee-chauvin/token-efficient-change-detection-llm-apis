...
# slugified model#provider, as in production
ENDPOINT_SLUG = "mistralai2fmistral-7b-instruct-v0.323together"
DATA_DIR = root / "data"
...
def load_endpoint() -> EndpointData:
    endpoint_dir = DATA_DIR / ENDPOINT_SLUG
